        ...
        <>
          ...
          >
            <div
              ...
              aria-label={title}
              tabIndex={-1}
              className="bg-white dark:bg-[#121212] border border-black/10 dark:border-white/10 w-full max-w-md rounded-3xl p-5 md:p-8 shadow-2xl pointer-events-auto relative max-h-[90vh] overflow-y-auto transition-colors duration-300 focus:outline-none"
            >
