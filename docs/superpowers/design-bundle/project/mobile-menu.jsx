...
const PrMobileMenu = () => {
  const links = [
    { n: '01', t: 'Главная', sub: 'старт' },
    { n: '02', t: 'Курсы', sub: '3 тарифа · от 50 000 ₽' },
    { n: '03', t: 'Инструкторы', sub: 'команда из 3 человек' },
    { n: '04', t: 'Отзывы', sub: '5.0 · 54+ на Авито', active: true },
    { n: '05', t: 'Вопросы', sub: 'FAQ · рассрочка · возврат' },
    { n: '06', t: 'Запись', sub: 'оставить заявку' },
  ];
  return (
    <div className="pr-site pr-menu-root" style={{
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <nav style={{ padding: '0 20px' }}>
          {links.map((l, i) => (
            <a key={i} className="pr-menu-item" style={{
