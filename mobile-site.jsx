...
const PrMSCourses = () => {
  const courses = [
    { tag: 'БАЗОВЫЙ', title: 'СТАРТ', price: '50 000', hours: 'Категория B',
      pitch: 'Идеальный старт для уверенного вождения.',
      features: ['42 часа на автомат', '44 часа на механику'],
      accent: false },
    { tag: 'ХИТ · 70% ВЫБИРАЮТ', title: 'ПРЕМИУМ', price: '65 000', hours: '54 ч АКПП · 56 ч МКПП',
      ...
      features: ['Бесплатный внутренний экзамен', 'Неограниченное число занятий', 'Индивидуальный график', 'Забираем из дома', 'Все походы на экзамен бесплатны', 'Сопровождение на всех этапах'],
      accent: true },
    { tag: 'VIP', title: 'VIP', price: '110 000', hours: 'Без лимита часов',
      pitch: 'Максимальный комфорт и гарантия результата.',
      features: ['Автомобиль премиум-класса', 'Неограниченное число занятий', 'Индивидуальный график', 'Забираем из дома', 'Все экзамены бесплатно (внутр., ГИБДД, вождение + теория)', 'Сопровождение на всех этапах'],
...
const MS_INSTRUCTORS = [
  ...
  { name: 'ДМИТРИЙ', surname: 'АНДРЕЕВИЧ БЕЛОНОГОВ · ИНСТРУКТОР', img: 'assets/instructor_dmitry_b.jpg',
    tag: 'ГОРОДСКОЙ ПОТОК',
